...
p.resetDebugVisualizerCamera( cameraDistance=1, cameraYaw=0, cameraPitch=-30, cameraTargetPosition=[0,-1, 0.6])
...
# Indices of the joints in the body part (ID of parts in program)
...
# Dimension & Displacement factors for the DoggiE
xhipf = 0.4
xhipb = -0.4
yhipl = 0.1
...
yawri = 1.3
# xrOi is the initial x coordinate of the robot in the world-centered coordinates [x, y, z]
xrOi = np.array([0,0,1])
...
# xBOi is the initial x coordinate of the body in the world-centered coordinates 
xbOi = xrOi
...
# setlegsxyz(xvec, yvec, zvec, velocity)
